        ...
        <div class="row pt-2">
            ...
            <div class="col-lg-9">
                ...
                <form method="post" action="{{ route('doctor.appointments.save') }}">
                    ...
                    <div class="row">
                        @php 
                            $from = strtotime($settings->stime); $end = strtotime($settings->etime); $dur = $settings->time_per_appointment; $bstime = strtotime($settings->bstime); $betime = strtotime($settings->betime); $c = 0; $index = -1;
